...
def scan_domain(domain):
    ...
    with open("da_pa_result.txt", "a") as file:
        file.write(result)
...
██████╔╝██║░░██║  ╚█████╔╝██║░░██║███████╗╚█████╔╝██║░╚██╗███████╗██║░░██║
╚═════╝░╚═╝░░╚═╝  ░╚════╝░╚═╝░░╚═╝╚══════╝░╚════╝░╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝
\tCoded By #No_Identity - https://github.com/cexploit99
\tContact Me : exploit99.my.id@gmail.com
\tApi Provided by :  api.xploitsec.com
    """
    print(banner)
